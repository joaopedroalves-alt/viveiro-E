...
function marcarNotificacaoComoLida(id) {
  ...
  lista.forEach(function (notificacao) {
    ...
    if (
      Number(notificacao.id) === Number(id)
    ) {
...
function publicarIdeia() {
  ...
  /* tira a mensagem depois de um tempo */
