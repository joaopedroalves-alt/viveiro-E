# Diário da sprint — E · base [V-01 a V-12]
...
* Manter as histórias que já possuem critérios claros.
* Corrigir apenas as histórias que apresentam ambiguidades.
* Elaborar um backlog revisado como base para o restante do projeto.
